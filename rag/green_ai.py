...
def evaluate_risk(vehicle_id: str, payload_data: dict) -> str | None:
    """
    ...
    Returns:
        str | None: LLM-generated resolution text or None if evaluation fails.
    """
    try:
        ...
        logger.error(f"RouteZero AI inference rejected: {e}")
        return None
